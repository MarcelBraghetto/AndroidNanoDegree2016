...
public class Artwork {
    ...
    private static final String INTENT_BUNDLE_KEY = "IntentBundleKey";
    ...
    @NonNull
    public static Bundle getIntentBundle(@NonNull Intent intent) {
    ...
    /**
     * Attempt to parse out an artwork from the given intent.
     * @param intent to extract the artwork from
     * @return artwork object or null.
     */
    public static Artwork getFrom(@NonNull Intent intent) {
        Bundle bundle = intent.getBundleExtra(INTENT_BUNDLE_KEY);
        ...
        return Artwork.getFrom(bundle);
    }

    /**
     * Put the current artwork instance into the given bundle.
     * @param bundle to put the artwork into.
     */
    public void putInto(@NonNull Bundle bundle) {
        bundle.putParcelable(BUNDLE_KEY, Parcels.wrap(this));
    }
