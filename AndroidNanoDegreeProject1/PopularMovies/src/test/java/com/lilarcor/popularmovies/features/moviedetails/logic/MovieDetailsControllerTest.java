...
public class MovieDetailsControllerTest {
    ...
    public void setUp() {
        ...
        mController = new MovieDetailsController(mMoviesProvider, mAppStringsProvider);
    }
    ...
    public void testInitControllerNullIntent() {
        ...
        // Run
        mController.initController(mDelegate, intent);
    }
    ...
    public void testToggleFavouriteSelectedIsAlreadyFavourite() {
        ...
        Intent intent = new Intent();
        intent.putExtra("MDCMI", textDataMovieId);
