...
public class MoviesContentContractTest {
    ...
    public void testMoviesTable() {
        ...
        assertThat(Movies.getBulkInsertSql(), is("INSERT INTO movies(_id, movie_title, movie_overview, movie_release_date, movie_poster_path, movie_backdrop_path, movie_vote_average, movie_vote_count, is_favourite) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)"));
        assertThat(Movies.getBulkUpdateSql(), is("UPDATE movies SET movie_title= ?, movie_overview= ?, movie_release_date= ?, movie_poster_path= ?, movie_backdrop_path= ?, movie_vote_average= ?, movie_vote_count= ? WHERE _id = ?"));
    ...
    public void testPopularMoviesTable() {
        ...
        assertThat(PopularMovies.getBulkInsertSql(), is("INSERT INTO popular_movies(movie_id, result_page) VALUES(?, ?)"));
    ...
    public void testTopRatedMoviesTable() {
        ...
        assertThat(TopRatedMovies.getBulkInsertSql(), is("INSERT INTO top_rated_movies(movie_id, result_page) VALUES(?, ?)"));
