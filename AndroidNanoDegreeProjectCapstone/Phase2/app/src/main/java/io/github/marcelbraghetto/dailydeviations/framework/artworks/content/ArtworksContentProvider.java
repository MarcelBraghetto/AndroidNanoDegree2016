package io.github.marcelbraghetto.dailydeviations.framework.artworks.content;
...
import static io.github.marcelbraghetto.dailydeviations.framework.artworks.content.ArtworksDatabaseContract.Artworks.SAVE_FAVOURITE_PARAM_GUID;
import static io.github.marcelbraghetto.dailydeviations.framework.artworks.content.ArtworksDatabaseContract.Artworks.SAVE_FAVOURITE_PARAM_IS_FAVOURITE;
import static io.github.marcelbraghetto.dailydeviations.framework.artworks.content.ArtworksDatabaseContract.Artworks.TABLE_NAME;
import static io.github.marcelbraghetto.dailydeviations.framework.artworks.content.ArtworksDatabaseContract.Artworks._ID;
import static io.github.marcelbraghetto.dailydeviations.framework.artworks.content.ArtworksDatabaseContract.Artworks.getContentItemType;
import static io.github.marcelbraghetto.dailydeviations.framework.artworks.content.ArtworksDatabaseContract.Artworks.getContentType;
import static io.github.marcelbraghetto.dailydeviations.framework.artworks.content.ArtworksDatabaseContract.Artworks.getCreateTableSql;
import static io.github.marcelbraghetto.dailydeviations.framework.artworks.content.ArtworksDatabaseContract.BASE_CONTENT_URI;
import static io.github.marcelbraghetto.dailydeviations.framework.artworks.content.ArtworksDatabaseContract.CONTENT_AUTHORITY;
import static io.github.marcelbraghetto.dailydeviations.framework.artworks.content.ArtworksDatabaseContract.CONTENT_PATH_ARTWORKS;
import static io.github.marcelbraghetto.dailydeviations.framework.artworks.content.ArtworksDatabaseContract.CONTENT_PATH_ARTWORKS_COUNT;
import static io.github.marcelbraghetto.dailydeviations.framework.artworks.content.ArtworksDatabaseContract.CONTENT_PATH_ARTWORKS_FAVOURITES;
import static io.github.marcelbraghetto.dailydeviations.framework.artworks.content.ArtworksDatabaseContract.CONTENT_PATH_ARTWORKS_SAVE_FAVOURITE;
import static io.github.marcelbraghetto.dailydeviations.framework.artworks.content.ArtworksDatabaseContract.CONTENT_PATH_LATEST_ARTWORKS;
import static io.github.marcelbraghetto.dailydeviations.framework.artworks.content.ArtworksDatabaseContract.CONTENT_PATH_RANDOM_ARTWORK;
...
public class ArtworksContentProvider extends ContentProvider {
    ...
    private static final int MATCHER_ID_LATEST_ARTWORKS = 102;
    private static final int MATCHER_ID_FAVOURITE_ARTWORKS = 103;
    private static final int MATCHER_ID_ARTWORKS_COUNT = 104;
    private static final int MATCHER_ID_SAVE_FAVOURITE = 105;
    private static final int MATCHER_ID_RANDOM_ARTWORK = 106;
    ...
    public ArtworksContentProvider() {
        ...
        mUriMatcher.addURI(CONTENT_AUTHORITY, CONTENT_PATH_LATEST_ARTWORKS, MATCHER_ID_LATEST_ARTWORKS);
        ...
        mUriMatcher.addURI(CONTENT_AUTHORITY, CONTENT_PATH_RANDOM_ARTWORK, MATCHER_ID_RANDOM_ARTWORK);
    }
    ...
    public synchronized Cursor query(@NonNull Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch(mUriMatcher.match(uri)) {
            ...
            case MATCHER_ID_RANDOM_ARTWORK: {
                String query = "SELECT * FROM " + TABLE_NAME + " LIMIT 1 OFFSET ABS(RANDOM()) % MAX((SELECT COUNT(*) FROM " + TABLE_NAME + "), 1)";
            ...
            case MATCHER_ID_LATEST_ARTWORKS: {
                String query = "SELECT * FROM " + TABLE_NAME + " ORDER BY " + COLUMN_TIMESTAMP + " DESC LIMIT " + ArtworksDatabaseContract.LATEST_ARTWORKS_LIMIT;
                cursor = mDatabase.rawQuery(query, null);
                break;
            }
