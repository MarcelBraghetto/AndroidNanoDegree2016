...
public final class ArtworksDatabaseContract {
    public static final String CONTENT_AUTHORITY = "io.github.marcelbraghetto.dailydeviations.framework.artworks.content.ArtworksContentProvider";
    public static final String CONTENT_PATH_ARTWORKS = "artworks";
    public static final String CONTENT_PATH_LATEST_ARTWORKS = "latest_artworks";
    public static final String CONTENT_PATH_RANDOM_ARTWORK = "random_artwork";
    ...
    public static final int LATEST_ARTWORKS_LIMIT = 20;
    ...
    public static final class Artworks implements BaseColumns {
        ...
        private static final Uri LATEST_ARTWORKS_CONTENT_URI = BASE_CONTENT_URI.buildUpon().appendPath(CONTENT_PATH_LATEST_ARTWORKS).build();
        private static final Uri RANDOM_ARTWORK_CONTENT_URI = BASE_CONTENT_URI.buildUpon().appendPath(CONTENT_PATH_RANDOM_ARTWORK).build();
        ...
        @NonNull
        public static Uri getContentUriLatestArtworks() {
            return LATEST_ARTWORKS_CONTENT_URI;
        }
        ...
        @NonNull
        public static Uri getContentUriRandomArtwork() {
            return RANDOM_ARTWORK_CONTENT_URI;
        }
