...
public class HomeFeatureTest {
    ...
    public void verifyPopularMovie() {
        ...
        onView(withId(R.id.movie_details_about_text)).check(matches(withText("Jurassic World was released on Friday 12 June 2015.\n\nTwenty-two years after the events of Jurassic Park, Isla Nublar now features a fully functioning dinosaur theme park, Jurassic World, as originally envisioned by John Hammond.")));
    ...
    public void verifyTopRatedMovie() {
        ...
        onView(withId(R.id.movie_details_about_text)).check(matches(withText("Interstellar was released on Wednesday 5 November 2014.\n\nInterstellar chronicles the adventures of a group of explorers who make use of a newly discovered wormhole to surpass the limitations on human space travel and conquer the vast distances involved in an interstellar voyage.")));
    ...
    public void verifyFavouriteMovie() {
        ...
        onView(withId(R.id.movie_details_about_text)).check(matches(withText("Terminator Genisys was released on Wednesday 1 July 2015.\n\nThe year is 2029. John Connor, leader of the resistance continues the war against the machines. At the Los Angeles offensive, John's fears of the unknown future begin to emerge when TECOM spies reveal a new plot by SkyNet that will attack him from both fronts; past and future, and will ultimately change warfare forever.")));
