...
import static io.github.marcelbraghetto.dailydeviations.framework.artworks.content.ArtworksDatabaseContract.Artworks.getAllColumnsIndexMap;
import static io.github.marcelbraghetto.dailydeviations.framework.artworks.content.ArtworksDatabaseContract.Artworks.getContentUriAllArtworks;
import static io.github.marcelbraghetto.dailydeviations.framework.artworks.content.ArtworksDatabaseContract.Artworks.getContentUriArtworkCount;
import static io.github.marcelbraghetto.dailydeviations.framework.artworks.content.ArtworksDatabaseContract.Artworks.getContentUriFavouriteArtworks;
import static io.github.marcelbraghetto.dailydeviations.framework.artworks.content.ArtworksDatabaseContract.Artworks.getContentUriRandomArtwork;
import static io.github.marcelbraghetto.dailydeviations.framework.artworks.content.ArtworksDatabaseContract.Artworks.getContentUriSaveFavourite;
import static io.github.marcelbraghetto.dailydeviations.framework.artworks.content.ArtworksDatabaseContract.Artworks.getContentUriSpecificArtwork;
...
public class DefaultArtworksProvider implements ArtworksProvider {
    ...
    @NonNull
    @Override
    public Uri getArtworks(@NonNull CollectionFilterMode category) {
        switch(category) {
            case Favourites:
    ...
    public Artwork getRandomArtwork() {
        Cursor cursor = mApplicationContext.getContentResolver().query(getContentUriRandomArtwork(), null, null, null, null);
