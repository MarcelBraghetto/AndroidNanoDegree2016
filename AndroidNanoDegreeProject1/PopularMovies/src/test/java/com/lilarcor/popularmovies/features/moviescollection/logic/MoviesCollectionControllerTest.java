...
public class MoviesCollectionControllerTest {
    ...
    public void setUp() {
        ...
        when(mDeviceInfoProvider.getCurrentWindowWidth()).thenReturn(1000);
    ...
    public void testInitControllerNullArgumentsBundle() {
        ...
        // Run
        mController.initController(mDelegate, arguments);
    }
    ...
    public void testInitControllerPopularMovies() {
        ...
        verify(mDeviceInfoProvider).getCurrentWindowWidth();
    ...
    @Test
    public void testMovieIdSelected() {
        Bundle arguments = new Bundle();
        arguments.putSerializable("MCCMMF", MoviesCollectionFilter.Popular);
        mController.initController(mDelegate, arguments);
    ...
    public void testOnPopularMoviesRequestFailedEventRequestPageIs1() {
        ...
        // Verify
        verify(mDelegate).hideSwipeIndicator();
        verify(mDelegate).showSnackbar("Connection problem. Check your data connection and swipe down to try again.");
    }
