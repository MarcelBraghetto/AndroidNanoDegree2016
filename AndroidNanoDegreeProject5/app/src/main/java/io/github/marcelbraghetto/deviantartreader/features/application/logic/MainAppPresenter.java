package io.github.marcelbraghetto.deviantartreader.features.application.logic;
 ...
 */
public class MainAppPresenter implements EventBusSubscriber {
    ...
    @Inject
    public MainAppPresenter(@NonNull Context applicationContext,
